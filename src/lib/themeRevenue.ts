...
export const REVENUE_GROWTH_COLUMNS: RevenueColumnDef[] = [
  {
    id: "l5q",
    label: "L5Q\nAct",
    tooltip: "YoY growth for the reported quarter five back from LQ. Accel mode starts at L4Q (L4Q minus L5Q).",
  ...
  },
  {
    id: "l4q",
    label: "L4Q\nAct",
    tooltip: "YoY growth for the reported quarter four back from LQ. Accel is L4Q minus L5Q (pp).",
    growthKey: "l4q_rev_act_pct",
    accelKey: "l4q_accel_pp",
    format: "pct",
  },
  {
    id: "l3q",
    label: "L3Q\nAct",
    tooltip: "YoY growth for the reported quarter three back from LQ. Accel is L3Q minus L4Q (pp).",
    growthKey: "l3q_rev_act_pct",
    accelKey: "l3q_accel_pp",
    format: "pct",
  },
  {
    id: "l2q",
    label: "L2Q\nAct",
    tooltip: "YoY growth for the reported quarter before LQ. Accel is L2Q minus L3Q (pp).",
    growthKey: "l2q_rev_act_pct",
    accelKey: "l2q_accel_pp",
    format: "pct",
  },
  {
    id: "lq",
    label: "LQ\nAct",
    tooltip: "YoY growth for the most recent reported quarter. Accel is LQ minus L2Q (pp).",
    growthKey: "lq_rev_act_pct",
    accelKey: "lq_accel_pp",
    format: "pct",
  },
  {
    id: "cq",
    label: "CQ\nEst",
    tooltip: "YoY growth for the next unreported quarter. Accel is CQ minus LQ (pp).",
  ...
  },
  {
    id: "nq",
    label: "NQ\nEst",
    tooltip: "YoY growth for the quarter after CQ. Accel is NQ minus CQ (pp).",
...
export const REVENUE_REVISION_GROUPS: { id: string; label: string; title: string; columnIds: string[] }[] = [
  {
    id: "cq",
    label: "CQ",
    title: "Lock-quarter (vendor 0q) consensus YoY revenue growth revisions",
    columnIds: ["rev_latest", "rev_first", "rev_delta", "rev_low", "rev_high"],
  },
  {
    id: "cy",
    label: "CY",
  ...
  },
  {
    id: "ny",
    label: "NY",
    title: "Next year (vendor +1y) consensus YoY revenue growth revisions",
    columnIds: ["ny_rev_latest", "ny_rev_first", "ny_rev_delta"],
  },
];
